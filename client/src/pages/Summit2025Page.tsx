    ...
    <div className="min-h-screen bg-background flex flex-col relative">
      ...
      <div className="flex-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <Card className="h-full hover:shadow-lg transition-shadow" data-testid="card-startup-fair">
                <CardContent className="p-8 flex flex-col h-full">
                  <h3 className="text-2xl font-bold mb-4 text-foreground">Startup Fair</h3>
              ...
              <Card className="h-full hover:shadow-lg transition-shadow" data-testid="card-main-stage">
                <CardContent className="p-8 flex flex-col h-full">
                  <h3 className="text-2xl font-bold mb-4 text-foreground">Main Stage</h3>
                  <p className="text-muted-foreground mb-6 flex-grow">
              ...
              <Card className="h-full hover:shadow-lg transition-shadow" data-testid="card-keynote-panels">
                <CardContent className="p-8 flex flex-col h-full">
                  <h3 className="text-2xl font-bold mb-4 text-foreground">Keynote & Panels</h3>
                  <p className="text-muted-foreground mb-6 flex-grow">
        ...
        <div className="py-16 md:py-20">
          <PageContainer className="max-w-[1140px]">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Speakers & Panelists</h2>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6" data-testid="speakers-grid">
